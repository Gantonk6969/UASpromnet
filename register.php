...
if(isset($_POST['submit'])) {
	...
	if($user == "" || $pass == "" || $name == "" || $email == "") {
		...
		mysqli_query($mysqli, "INSERT INTO login(name, email, username, password, role) VALUES('$name', '$email', '$user', md5('$pass'), $role)")
...
<div class="block-form"></div>
	<div class="jumbotron"><font size="+2">Register</font></div>
	<div>
	<form name="form1" method="post" action="">
		<table width="100%" border="0" class="table">
			...
			<tr> 
				<td>Username</td>
				<td><input class="input1" type="text" name="username"></td>
			</tr>
			<tr> 
				<td>Password</td>
